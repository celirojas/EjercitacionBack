...
public class OdontologoDAOH2 implements Idao <Odontologo> {
    ...
    //INIT=RUNSCRIPT: cuando se conecta a la base ejecuta el script de sql
    ...
    public Odontologo guardar(Odontologo odontologo) {
        ...
        try{
            ...
            //No le paso el ID ya que es autoincremental desde la base de datos
    ...
    public Odontologo buscar(int id) {
        ...
        //Logueamos que se encontró el odontologo
    ...
    public void eliminar(int id) {
        ...
        try{
            ...
            logger.error("No se pudo eliminar el odontologo.");
            e.printStackTrace();
        }
        finally{
            try{
        ...
        //Logueamos que se eliminó el odontologo
        logger.info("El odontologo de id número " + id + " se ha eliminado");
    }
